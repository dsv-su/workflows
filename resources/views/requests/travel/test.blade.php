@php
    $selcountry = $countries->pluck('country')->toJson();
@endphp
<div>
    ...
    <div
        ...
        x-data="select({ data: {{$selcountry}} , emptyOptionsMessage: 'No countries match your search.', name: 'country', placeholder: 'Select a country' })"
        {{--}}
